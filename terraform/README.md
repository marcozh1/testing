...
```
curl "https://nubesgen.com/demo.tgz?iactool=TERRAFORM&region=eastus&application=APP_SERVICE.free&runtime=DOCKER_SPRING&database=NONE.free&gitops=true" | tar -xzvf -
```
